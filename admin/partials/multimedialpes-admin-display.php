...
<table class="widefat">
    ...
    <?php foreach($types as $type): ?>
        <tr>
            ...
            <td class="edit-td">
                <form method="post" class="edit-type">
                    ...
                    <input type='text' name="color" class='color-field js-edit-color' value="<?= $type->color ?>">
                    <button type="submit" class="button-primary" style="display: none">Enregistrer</button>
                </form>
            </td>
            <td>
                <form method="post">
...
<form method="post">
    ...
    <p>
        <label for="addColor">Couleur d'affichage: </label>
        <input type='text' name="color" id="addColor" class='color-field-add'>
    </p>
    <p>
      <?php
